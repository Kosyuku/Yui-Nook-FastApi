(() => {
  ...
  const builtinApps = [
    { id: 'wechat', icon: '微', label: '微信', type: '应用' },
    { id: 'moments', icon: '圈', label: '朋友圈', type: '应用' },
    { id: 'photos', icon: '册', label: '相册', type: '应用' },
    { id: 'notes', icon: '记', label: '备忘录', type: '应用' },
    { id: 'calendar', icon: '历', label: '日历', type: '应用' },
    { id: 'mall', icon: '店', label: '商城', type: '应用' },
    { id: 'music', icon: '乐', label: '音乐', type: '应用' },
    { id: 'worldbook', icon: '书', label: '世界书', type: '应用' },
    { id: 'settings', icon: '设', label: '设置', type: '应用' },
    { id: 'love', icon: '恋', label: '在一起', type: '插件' },
    { id: 'bubble', icon: '泡', label: '消息气泡', type: '插件' },
    { id: 'todo', icon: '办', label: '待办', type: '插件' },
    { id: 'weather', icon: '晴', label: '天气', type: '插件' },
  ];
